      ...
      <main className="overflow-x-hidden bg-white text-slate-900">
        ...
        <section className="relative overflow-hidden border-b border-slate-200 bg-[radial-gradient(circle_at_top_left,_rgba(139,92,246,0.10),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(14,165,233,0.08),_transparent_28%),linear-gradient(to_bottom,_#ffffff,_#f8fafc)]">
          <div className="mx-auto grid max-w-7xl gap-14 px-6 py-20 md:py-28 lg:grid-cols-[1.06fr_0.94fr] lg:items-center">
            <FadeUp>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link
                  ...
                  className="inline-flex min-h-[48px] items-center justify-center rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-slate-50"
                >
            ...
            <FadeUp>
              <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_20px_80px_rgba(15,23,42,0.08)] md:p-8">
                <div className="grid gap-4">
                  <div className="rounded-[24px] bg-violet-50 p-6">
                    <p className="text-sm uppercase tracking-[0.2em] text-violet-700">
                      Product Stack
                    </p>
                    <div className="mt-4 rounded-2xl bg-white p-4 text-center font-semibold text-slate-900 shadow-sm">
                      Frontend Experience
                    </div>
        ...
        <section className="py-16 md:py-20">
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
              {process.map((item) => (
                <FadeUp key={item.no}>
                  <article className="group rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md">
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-700 transition hover:border-slate-400 hover:bg-slate-50"
                >
                  ←
                </button>
                <button
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="rounded-[40px] border border-violet-100 bg-violet-50 p-10 text-center shadow-lg md:p-16">
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-4">
                ...
                <Link
                  href="/blogs/"
                  className="inline-flex min-h-[48px] items-center justify-center rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
                >
                  Explore Insights
                </Link>
              </div>
