        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="max-w-4xl">
            ...
            <h2 className="mt-8 text-5xl font-bold leading-[1.02] text-[var(--text)] md:text-6xl">
              Every growth system should work together.
            </h2>
          </div>
          ...
          <div className="mt-20 grid gap-8 lg:grid-cols-3">
            ...
            {/* CARD */}
            <div className="hover-card rounded-[36px] bg-gradient-to-br from-[#7C3AED] to-[#A78BFA] p-8 text-white shadow-[0_25px_60px_rgba(124,58,237,0.2)]">
              <div className="text-5xl">📈</div>

              <h3 className="mt-8 text-3xl font-semibold">Content Systems</h3>
