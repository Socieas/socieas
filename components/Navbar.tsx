...
export default function Navbar() {
  ...
  const services = [
    {
      ...
      desc: "Founder visibility and authority systems.",
      href: "/services/personal-branding",
    },
    {
      title: "CRM Solutions",
      desc: "Connected business workflow systems.",
      href: "/services/crm-solutions",
    },
    {
      title: "AI Automation",
      desc: "Operational automation and AI workflows.",
      href: "/services/ai-automation",
    },
    {
      title: "Full Stack Development",
      desc: "Modern scalable digital infrastructure.",
      href: "/services/full-stack-development",
    },
    {
      title: "Digital Marketing",
      desc: "Growth systems and audience acquisition.",
      href: "/services/digital-marketing",
    },
    {
      title: "Staffing Solutions",
      desc: "Operational hiring and scaling systems.",
  ...
  const insights = [
    {
      title: "Blogs",
      desc: "SEO focused educational content.",
      href: "/insights/blogs",
    },
    {
      title: "Articles",
      desc: "Strategic and research insights.",
...
/>
              ...
              <nav className="ml-16 hidden items-center gap-1 xl:flex">
                ...
                >
                  <div
                    className={`flex items-center rounded-full transition-all duration-300 hover:bg-violet-50 ${
                      pathname.startsWith("/services") ? "bg-violet-50" : ""
                    }`}
                  >
                    <Link
                      href="/services"
                ...
                >
                  <div
                    className={`flex items-center rounded-full transition-all duration-300 hover:bg-violet-50 ${
                      pathname.startsWith("/insights") ? "bg-violet-50" : ""
                    }`}
                  >
                    <Link
                      href="/insights"
          ...
          <div
            className={`xl:hidden transition-all duration-500 ${
              mobileMenuOpen
                ? "pointer-events-auto visible mt-3 translate-y-0 opacity-100"
