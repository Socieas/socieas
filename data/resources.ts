...
export const categories: CategoryMeta[] = [
  ...
  },
  {
    ...
    description:
      "Practical AI workflows that save hours every week — no engineering team required.",
  },
  {
    slug: "crm",
    label: "CRM & Pipelines",
  ...
  },
  {
    ...
    description:
      "Scorecards and hiring systems that protect you from expensive mis-hires.",
  },
];
...
export const resources: Resource[] = [
  {
    ...
    promise:
      "Turn your LinkedIn profile into an inbound lead machine in 12 minutes — the exact 21-point audit we run for clients.",
    description:
      "Most founder profiles read like resumes. Buyers don't hire resumes — they hire authority. This checklist walks you through the 21 fixes we make on every client profile: headline formula, banner, featured section, about-section story arc, and the credibility signals buyers scan for in the first 8 seconds.",
    category: "personal-branding",
    type: "Checklist",
    time: "12 min",
    bullets: [
      "The headline formula that says what you do and who it's for — in under 120 characters",
      "8-second test: the 3 things buyers check before they read anything else",
      "The about-section story arc that turns visitors into DMs",
      "Featured-section setup that does the selling while you sleep",
      "21 checkboxes — do them top to bottom, done in 12 minutes",
    ],
    whoFor: [
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. It's the same audit we run in paid engagements. We give it away because founders who fix their profile usually want help with the next step — content.",
      },
      {
  ...
  },
  {
    ...
    description:
      "The first line decides whether your post lives or dies. We collected and categorized 100 hooks from top-performing founder content — story hooks, contrarian hooks, list hooks, result hooks — so you can open every post with a line that earns the click on 'see more'.",
    category: "personal-branding",
    type: "Swipe File",
    time: "5 min",
    bullets: [
      "100 hooks across 8 categories — story, contrarian, result, mistake, list, question, statistic, POV",
      "Fill-in-the-blank format: swap in your industry and post",
    ...
    faqs: [
      {
        ...
        answer:
          "They're patterns, not copies. Each hook is a reusable structure with the specifics stripped out so it becomes yours when you fill it in.",
      },
    ],
  ...
  },
  {
    ...
    promise:
      "Turn your background into a story buyers remember — a 5-part narrative worksheet used in our positioning sprints.",
    description:
      "People forget features. They remember stories. This worksheet extracts the one founder story you should be telling — the struggle, the shift, the system — and shapes it into an about-section, a keynote intro, and a pinned post.",
    category: "personal-branding",
    type: "Worksheet",
    time: "20 min",
    bullets: [
      ...
      "Three output formats: LinkedIn about, bio, pinned post",
      "Real before/after example included",
    ],
    whoFor: [
      "Founders who freeze when asked 'so, what's your story?'",
      "Experts whose credentials are strong but forgettable",
      "Anyone building a brand on trust",
    ],
    whoNotFor: ["Companies wanting corporate brand messaging — this is personal"],
    faqs: [
      {
        question: "What if my story feels ordinary?",
        answer:
          "Ordinary stories told with structure beat dramatic stories told badly. The framework works precisely because it doesn't need drama.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Most businesses either over-hype AI or ignore it. This audit cuts through both. Score your operations across 6 areas — lead handling, content, admin, reporting, support, and follow-up — and get a clear picture of where automation pays off first.",
    category: "ai-automation",
    type: "Worksheet",
    time: "10 min",
    bullets: [
      "6-area scoring system with clear 1–5 criteria",
      "The automation priority matrix: impact vs. effort",
      "Red flags that mean you're NOT ready to automate yet",
    ...
    faqs: [
      {
        ...
        answer:
          "None. It's a business audit, not a technical one. You score how work happens today and the matrix shows where automation helps most.",
      },
    ],
  ...
  },
  {
    ...
    promise:
      "25 copy-paste prompts that make ChatGPT work like a strategist, ghostwriter, and analyst — not a generic intern.",
    description:
      "Generic prompts get generic output. This pack contains 25 battle-tested prompts we use daily — for positioning, content repurposing, offer copy, competitor analysis, and follow-up emails — each with the context structure that makes AI output actually usable.",
    category: "ai-automation",
    type: "Prompt Pack",
    time: "5 min",
    bullets: [
      ...
      "Repurposing chain: 1 long post → 10 pieces of content",
    ...
    whoNotFor: ["Prompt engineers — this is practical, not technical"],
    faqs: [
      {
  ...
  },
  {
    ...
    time: "15 min",
    bullets: [
      "7 stages from first touch to closed — with clear exit criteria",
      "The follow-up cadence: day 2, day 5, day 12, day 30",
      "Deal health signals: when to push and when to walk away",
    ...
    whoNotFor: ["E-commerce businesses — this is built for service sales"],
    faqs: [
      {
  ...
  },
  {
    ...
    promise:
      "Set up a CRM that your team actually uses — the 18 steps that separate adopted systems from abandoned ones.",
    description:
    ...
    bullets: [
      ...
      "The 5 fields every lead record needs (and 10 you should delete)",
      "Automation rules that save 3+ hours a week",
      "The weekly ritual that keeps your CRM from dying",
    ],
    whoFor: [
    ...
    faqs: [
      {
        ...
        answer:
          "Tool-agnostic. The steps apply to HubSpot, Zoho, Pipedrive, Salesforce, or Notion-based systems alike.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Service business SEO isn't about traffic — it's about the 50 searches a month that turn into calls. This checklist covers the 25 highest-leverage fixes: site structure, service page optimization, local signals, and the structured data that gets you cited by ChatGPT and AI Overviews.",
    category: "digital-marketing",
    type: "Checklist",
    time: "15 min",
    bullets: [
      "25 fixes ranked by impact — start at the top",
      "Service page structure that converts searchers into callers",
    ...
    whoFor: [
      ...
      "Marketers adapting to AI-driven search",
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "Technical fixes can move rankings in weeks. Content-driven gains typically compound over 3–6 months.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Consistency beats brilliance. This calendar gives you 30 days of specific post prompts rotating through 5 formats — story, lesson, framework, opinion, proof — so your content builds authority instead of noise.",
    category: "digital-marketing",
    type: "Template",
    time: "10 min",
    bullets: [
      "30 specific prompts — not vague themes",
      "5-format rotation that balances authority and relatability",
      "The 20-minute batching system: write a week in one sitting",
      "Repurposing map: every post becomes 3 pieces",
    ],
    whoFor: [
      "Founders who post for 2 weeks then vanish",
      "Anyone who spends more time deciding than writing",
      "Marketers managing an executive's presence",
    ],
    whoNotFor: ["Brands that need daily video scripts — this is text-first"],
    faqs: [
      {
  ...
  },
  {
    ...
    description:
      "A mis-hire costs 3–6 months of salary and a year of momentum. This scorecard forces clarity before interviews: outcomes over responsibilities, weighted scoring criteria, and the structured questions that reveal how candidates actually work.",
    category: "staffing",
    type: "Template",
    time: "15 min",
    bullets: [
      "Outcome-based role definition: what success looks like at 90 days",
      "Weighted scoring across skills, drive, and culture",
      "12 structured interview questions with what-to-listen-for notes",
      "The red-flag checklist most interviewers miss",
    ],
    whoFor: [
      "Founders making their first key hires",
      "Businesses burned by a recent mis-hire",
