...
export const metadata: Metadata = {
  title: "Free LinkedIn Profile Score | Socieas",
  description:
    "Get your LinkedIn profile scored out of 100 in 90 seconds. A 22 point audit across first impression, positioning, content, social proof, and conversion, with your 3 highest impact fixes free.",
};
    ...
    <main className="min-h-screen bg-[#F8F8F6] px-4 pb-24 pt-32 sm:px-6">
      ...
      <section className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mt-6 text-4xl font-extrabold leading-tight text-[#111111] sm:text-5xl">
          ...
          <span className="gradient-text">really worth?</span>
        </h1>
        <p className="mx-auto mt-5 max-w-xl text-lg leading-relaxed text-slate-600">
          The same 22 point audit we run for paying clients, automated. Paste
          your profile details, answer 12 quick questions, and get your score
          out of 100 with your 3 highest impact fixes. Free.
        </p>
        ...
        <div className="mx-auto mt-10 max-w-2xl overflow-hidden rounded-[32px] border border-slate-200">
          <Image
            ...
            alt="LinkedIn profile score tool by Socieas"
            width={1600}
            height={1000}
      ...
      <section className="mx-auto mt-16 max-w-2xl text-center">
        <p className="text-sm leading-relaxed text-slate-500">
          ...
          and your report is yours to keep. Built by Socieas, the team behind
          personal brands that actually convert.
        </p>
      </section>
    </main>
  );
