...
<tr><td><strong>Service Interested In:</strong></td><td>${goal || "N/A"}</td></tr>
...
<p style="margin-top:20px; font-size:12px; opacity:0.8;">Socieas • Building Growth That Scales</p>
</td>
</tr>
</table>
</td>
...
<h2 style="margin:0; color:#7c3aed; font-size:28px;">Thank You, ${name}</h2>
<p style="color:#6b7280; font-size:16px; line-height:1.8; margin-top:20px;">We’ve successfully received your inquiry.</p>
<p style="color:#6b7280; font-size:16px; line-height:1.8;">Our team is reviewing your requirements and will connect with you shortly.</p>
<p style="color:#6b7280; font-size:16px; line-height:1.8;">At Socieas, we help brands scale through strategy, digital marketing, CRM solutions, AI automation, and full stack development.</p>
</td>
</tr>
<tr>
<td align="center" style="padding-bottom:40px;">
<a href="${siteUrl}" style="background:#7c3aed; color:#ffffff; text-decoration:none; padding:14px 28px; border-radius:12px; font-weight:bold;">Explore Socieas</a>
</td>
</tr>
<tr>
<td style="background:#111111; padding:30px; text-align:center; color:#ffffff;">
