...
export const metadata = generateSEOMetadata({
    ...
    description: "Business growth insights, digital systems, strategic frameworks, and execution intelligence from Socieas.",
    path: "/insights/blogs",
});
...
export default async function BlogsPage({ searchParams }: {
  ...
  const blogs = posts.filter((post: any) => post.type === "blog");
