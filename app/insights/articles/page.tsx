...
export const metadata = generateSEOMetadata({
  ...
  description: "Deep strategic analysis, positioning frameworks, scalable systems, operational intelligence, and business growth thinking from Socieas.",
...
export default async function ArticlesPage({ searchParams }: {
  ...
  const articles = posts.filter((post: any) => post.type === "article");
  ...
  const filteredArticles = articles.filter((post: any) => {
