    ...
    <>
      <JsonLd schema={[
        serviceSchema({
          ...
          description: "Socieas builds scalable digital products through full stack development, frontend systems, backend infrastructure, and API integrations.",
        ...
        breadcrumbSchema([
          ...
          { name: "Full Stack Development", url: "https://socieas.com/services/full-stack-development" },
        ]),
