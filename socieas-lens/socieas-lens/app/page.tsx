...
export default function LandingPage() {
  return (
    <main className="overflow-x-hidden">
      {/* HERO */}
      <section className="relative px-6 pb-20 pt-24 text-center md:pt-32">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <ButtonLink href="/dashboard">Open your dashboard</ButtonLink>
      ...
      <section className="px-6 pb-24">
        <div className="gradient-cta mx-auto max-w-6xl rounded-hero px-8 py-16 text-center text-white md:py-20">
          ...
          <div className="mt-8">
            <ButtonLink href="/dashboard" variant="secondary" className="border-0">
              Get started free
            </ButtonLink>
          </div>
        </div>
